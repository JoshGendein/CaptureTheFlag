...
from gym_ctf.envs.modules.module import EnvModule
...
class Agents(EnvModule):
    ...
    def build_world_step(self, env):
        self.agents = []
        for i in range(self.n_agents):
            pos = placement_fn(env.grid_size, env.placement_grid, obj_size=(1, 1))
            ...
            env.placement_grid[pos[0]][pos[1]] = 128
